#!/usr/bin/env python3
"""
Alpaca Data Client for CANSLIM Screener
...
class AlpacaDataClient:
    ...
    def calculate_ema(self, prices: list[float], period: int) -> float:
        """Calculate Exponential Moving Average for the given prices and period.

        prices: list of floats, most-recent-first (same order as get_historical_prices returns)
        period: EMA period (e.g. 21 for 21-day EMA)
        Returns: EMA value as float, or 0.0 if insufficient data
        """
