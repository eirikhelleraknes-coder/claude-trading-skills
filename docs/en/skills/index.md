...
| [Scenario Analyzer]({{ '/en/skills/scenario-analyzer/' | relative_url }}) | Analyze news headlines into 18-month scenarios with sector impacts, stock picks, and second-opinion review | <span class="badge badge-free">No API</span> |
